...
if "TEST_USE_ENV" not in os.environ:
    ...
    del sys.modules["wormhole.settings"]
    del sys.modules["wormhole.settings.project"]

from wormhole.settings import *
...
EMAIL_BACKEND = "wormhole.conf.test_settings.MockEmailBackend"
