...
ROOT_URLCONF = "wormhole.settings.urls"

GRAPHENE = {
    "SCHEMA": "wormhole.settings.schema.application_schema",
    "SCHEMA_OUTPUT": "./schema.graphql",
    "MIDDLEWARE": ["graphql_jwt.middleware.JSONWebTokenMiddleware"],
}

DATABASE_HOST = os.environ.get("DATABASE_HOST", "psql")
DATABASE_NAME = os.environ.get("DATABASE_NAME", "wormhole")
DATABASE_USER = os.environ.get("DATABASE_USER", "wormhole")
DATABASE_PORT = os.environ.get("DATABASE_PORT", "5432")
DATABASE_PASSWORD = os.environ.get("DATABASE_PASSWORD", "wormhole")
DATABASES = {
...
APP_HOSTNAME = os.environ.get("APP_HOSTNAME", "wormhole.boundcorp.net")
...
AUTHENTICATION_BACKENDS = [
    "wormhole.utils.graphql.auth.GraphQLAuthBackend",
...
if os.path.exists(credentials_file):
    ...
    MINIO_STORAGE_MEDIA_BUCKET_NAME = os.environ.get("MINIO_STORAGE_MEDIA_BUCKET_NAME", "wormhole-assets")
